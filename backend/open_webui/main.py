...
app.state.config.IMAGE_OPENAI_USE_CONNECTION = IMAGE_OPENAI_USE_CONNECTION
app.state.config.IMAGE_OPENAI_CONNECTION_IDX = IMAGE_OPENAI_CONNECTION_IDX
...
app.state.config.IMAGE_EDIT_OPENAI_USE_CONNECTION = IMAGE_EDIT_OPENAI_USE_CONNECTION
app.state.config.IMAGE_EDIT_OPENAI_CONNECTION_IDX = IMAGE_EDIT_OPENAI_CONNECTION_IDX
